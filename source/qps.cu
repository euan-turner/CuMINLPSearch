...
Problem<double> problem_212() {
  ...
  problem.add_constraint(c1, Cmp::EQ, 6.5);
  Expr<double> c2 = 10 * x[0] + 10 * x[3] + x[5];
  problem.add_constraint(c2, Cmp::EQ, 20);
  return problem;
}
...
Problem<double> problem_219() {
  Problem<double> problem;
  auto x1 = problem.var(-5, 5);
  auto x2 = problem.var(-5, 5);
  auto x3 = problem.var(-5, 5);
  auto x4 = problem.var(-5, 5);
  auto x5 = problem.var(-5, 5);
  auto x6 = problem.var(-5, 5);
  auto x7 = problem.var(-5, 5);
  auto x8 = problem.var(-5, 5);
  auto x9 = problem.var(-5, 5);
  auto x10 = problem.var(-5, 5);
