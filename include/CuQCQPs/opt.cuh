...
__device__ CycleContext<CycleSize> make_cycle_context(
  std::size_t tid, int cycleStart)
{
...
__device__ void get_bounds(
  const CycleContext<CycleSize>& ctx, const interval::Bounds<T> *interval, std::size_t dim, interval::Bounds<T>& bound)
{
