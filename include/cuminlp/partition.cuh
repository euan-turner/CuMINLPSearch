 ...
 *        composition_policy.hpp): slots act on an explicit, possibly
 *        non-contiguous set of variables, each with its own fan-out and
 *        operation (bisect vs enumerate). Used by GraphReplay
 *        (graph_replay.cuh).
 *
