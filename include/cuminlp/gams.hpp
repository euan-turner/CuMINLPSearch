...
{
public:
  ParseError(int line, std::string const& message,
...
template<typename T>
auto parse(std::string_view source, ParseOptions const& options = {})
    -> ParsedModel<T>;
...
extern template auto parse<double>(std::string_view, ParseOptions const&)
    -> ParsedModel<double>;
extern template auto parse<float>(std::string_view, ParseOptions const&)
    -> ParsedModel<float>;
extern template auto parse_file<double>(std::filesystem::path const&,
                                        ParseOptions const&)
    -> ParsedModel<double>;
extern template auto parse_file<float>(std::filesystem::path const&,
                                       ParseOptions const&)
    -> ParsedModel<float>;
